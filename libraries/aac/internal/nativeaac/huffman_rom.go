...
//
// Code transcribed 1:1 from the vendored C ROM tables (aacEnc_rom.cpp); do not
// edit by hand.

package nativeaac

// huffltab1_2 is the 1:1 transcription of C FDKaacEnc_huff_ltab1_2 (aacEnc_rom.cpp).
var huffltab1_2 = [3][3][3][3]uint32{
	{
		{
...
// huffltab3_4 is the 1:1 transcription of C FDKaacEnc_huff_ltab3_4 (aacEnc_rom.cpp).
var huffltab3_4 = [3][3][3][3]uint32{
	{
		{
...
// huffltab5_6 is the 1:1 transcription of C FDKaacEnc_huff_ltab5_6 (aacEnc_rom.cpp).
var huffltab5_6 = [9][9]uint32{
...
// huffltab7_8 is the 1:1 transcription of C FDKaacEnc_huff_ltab7_8 (aacEnc_rom.cpp).
var huffltab7_8 = [8][8]uint32{
...
// huffltab9_10 is the 1:1 transcription of C FDKaacEnc_huff_ltab9_10 (aacEnc_rom.cpp).
var huffltab9_10 = [13][13]uint32{
...
// huffltab11 is the 1:1 transcription of C FDKaacEnc_huff_ltab11 (aacEnc_rom.cpp).
var huffltab11 = [17][17]uint8{
...
// huffltabscf is the 1:1 transcription of C FDKaacEnc_huff_ltabscf (aacEnc_rom.cpp).
var huffltabscf = [121]uint8{0x12, 0x12, 0x12, 0x12, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x12, 0x13, 0x12, 0x11, 0x11, 0x10, 0x11, 0x10, 0x10, 0x10, 0x10, 0x0f, 0x0f, 0x0e, 0x0e, 0x0e, 0x0e, 0x0e, 0x0e, 0x0d, 0x0d, 0x0c, 0x0c, 0x0c, 0x0b, 0x0c, 0x0b, 0x0a, 0x0a, 0x0a, 0x09, 0x09, 0x08, 0x08, 0x08, 0x07, 0x06, 0x06, 0x05, 0x04, 0x03, 0x01, 0x04, 0x04, 0x05, 0x06, 0x06, 0x07, 0x07, 0x08, 0x08, 0x09, 0x09, 0x0a, 0x0a, 0x0a, 0x0b, 0x0b, 0x0b, 0x0b, 0x0c, 0x0c, 0x0d, 0x0d, 0x0d, 0x0e, 0x0e, 0x10, 0x0f, 0x10, 0x0f, 0x12, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13, 0x13}

// huffctab1 is the 1:1 transcription of C FDKaacEnc_huff_ctab1 (aacEnc_rom.cpp).
var huffctab1 = [3][3][3][3]uint16{
	{
		{
...
// huffctab2 is the 1:1 transcription of C FDKaacEnc_huff_ctab2 (aacEnc_rom.cpp).
var huffctab2 = [3][3][3][3]uint16{
	{
		{
...
// huffctab3 is the 1:1 transcription of C FDKaacEnc_huff_ctab3 (aacEnc_rom.cpp).
var huffctab3 = [3][3][3][3]uint16{
	{
		{
...
// huffctab4 is the 1:1 transcription of C FDKaacEnc_huff_ctab4 (aacEnc_rom.cpp).
var huffctab4 = [3][3][3][3]uint16{
	{
		{
...
// huffctab5 is the 1:1 transcription of C FDKaacEnc_huff_ctab5 (aacEnc_rom.cpp).
var huffctab5 = [9][9]uint16{
...
// huffctab6 is the 1:1 transcription of C FDKaacEnc_huff_ctab6 (aacEnc_rom.cpp).
var huffctab6 = [9][9]uint16{
...
// huffctab7 is the 1:1 transcription of C FDKaacEnc_huff_ctab7 (aacEnc_rom.cpp).
var huffctab7 = [8][8]uint16{
...
// huffctab8 is the 1:1 transcription of C FDKaacEnc_huff_ctab8 (aacEnc_rom.cpp).
var huffctab8 = [8][8]uint16{
...
// huffctab9 is the 1:1 transcription of C FDKaacEnc_huff_ctab9 (aacEnc_rom.cpp).
var huffctab9 = [13][13]uint16{
...
// huffctab10 is the 1:1 transcription of C FDKaacEnc_huff_ctab10 (aacEnc_rom.cpp).
var huffctab10 = [13][13]uint16{
...
// huffctab11 is the 1:1 transcription of C FDKaacEnc_huff_ctab11 (aacEnc_rom.cpp).
var huffctab11 = [21][17]uint16{
