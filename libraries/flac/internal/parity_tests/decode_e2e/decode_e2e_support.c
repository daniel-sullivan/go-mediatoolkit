/* End-to-end decode parity — shared libFLAC support TU.
 *
 ...
 * two live in their own TUs (decode_e2e_encoder.c / decode_e2e_decoder.c),
 * mirroring the amalgamation split the main libraries/flac cgo package
