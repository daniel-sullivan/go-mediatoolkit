...
// Port of libopus/src/mlp_data.c — auto-generated weight tables
// from the Keras model. Values are taken verbatim from the C file.

var layer0_weights = []opus_int8{
	-30, -9, 2, -12, 5, -1, 8, 9,
...
var layer1_recur_weights = []opus_int8{
...
var layer2_bias = []opus_int8{
	14, 117,
}

// AnalysisDenseLayer layer0 = { bias, input_weights, nb_inputs, nb_neurons, sigmoid }
var layer0 = AnalysisDenseLayer{
	bias:          layer0_bias,
