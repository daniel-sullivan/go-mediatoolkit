...
// aec/internal/aec3's decimator.go against the fetched AEC3 C++
...
// TestDecimatorParitySkipped documents why the real parity tests
// aren't present in this build and how to enable them.
func TestDecimatorParitySkipped(t *testing.T) {
	t.Skip("AEC3 decimator parity tests require cgo and the fetched+built C++ oracle: " +
